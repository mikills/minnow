...
// Encode serialises the doc's media refs. Prefers explicit
...
// are no refs.
func Encode(mediaIDs []string, explicit []kb.ChunkMediaRef) (sql.NullString, error) {
...
// Decode parses the docs.media_refs column value. A null/empty
// column becomes nil (search hits omit the field).
func Decode(raw sql.NullString) ([]kb.ChunkMediaRef, error) {
